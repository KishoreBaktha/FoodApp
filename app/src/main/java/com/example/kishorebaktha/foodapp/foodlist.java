package com.example.kishorebaktha.foodapp;

/**
 * Created by KISHORE BAKTHA on 7/3/2017.
 */
...
public class foodlist extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new FoodAdapter(this, R.layout.food_items, list);
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        imageViewFood = (ImageView) dialog.findViewById(R.id.imageView3);
        final EditText edtName = (EditText) dialog.findViewById(R.id.editText3);
        final EditText edtPrice = (EditText) dialog.findViewById(R.id.editText4);
